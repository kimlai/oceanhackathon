    ...
    render() {
		...
		<div>
        	...
        	<div>
        		...
        		<button> Gestion </button> <span class = "spacer"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><button> Enjeux patrimoine nat. </button> <br/><br/>
				<button> Enjeux patrimoine culturel </button><span class = "spacer">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> <button> La pêche au siècle dernier </button>
